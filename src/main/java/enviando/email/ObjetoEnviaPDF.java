...
public class ObjetoEnviaPDF {
	...
	public ObjetoEnviaPDF(String listaDestinarios, String nomeRemetente, String assuntoEmail, String textoEmail) {
	...
	public void EnviarEmailPDF(boolean envioHTML) throws Exception {
		...
		/* Onde é passado o simulador de PDF pode ser passado o arquivo gravdo no banco de dados*/
	...
	private FileInputStream simuladorDePDF() throws Exception {
		...
		File file = new File("Arquivo-Anexo");
		file.createNewFile();
		PdfWriter.getInstance(document, new FileOutputStream(file)); 
		document.open();
		document.add(new Paragraph("Conteudo do PDF anoexo com JAVA Mail, esse texto ée do PDF"));
		document.close();
